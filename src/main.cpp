...
gpio_num_t LED_A = GPIO_NUM_1;
gpio_num_t LED_B = GPIO_NUM_2;
gpio_num_t LED_C = GPIO_NUM_3;
gpio_num_t LED_D = GPIO_NUM_10;
gpio_num_t BT_INICIAR_RECARGA = GPIO_NUM_9;
#define SPEED_MODE_TIMER LEDC_SPEED_MODE_MAX
#endif
